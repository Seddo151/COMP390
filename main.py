...
def handle_event(button_play, button_obstacle, button_food, placing_food, placing_obstacle):
    ...
    return True, placing_food, placing_obstacle
...
def main():
    ...
    while running:
        running, placing_food, placing_obstacle = handle_event(button_play, button_obstacle, button_food, placing_food, placing_obstacle)
